...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '咚~,咚~咚~,咚~咚~咚~🌟',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Reveone', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '个人知识库', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.reveone.cn/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, IOT, 物联网, AI, CTF, 软件逆向, reverse, 密码学', // 网站关键词 英文逗号隔开
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-L65D0L7J08', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
